...
type Frontmatter = {
  ...
  readonly thumbnailAlt: Maybe<Scalars['String']>;
...
type FrontmatterFilterInput = {
  ...
  readonly thumbnailAlt: Maybe<StringQueryOperatorInput>;
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.thumbnailAlt'
  ...
  | 'childMarkdownRemark.frontmatter.thumbnailAlt'
...
type SiteFieldsEnum =
  ...
  | 'siteMetadata.social.hatena'
  | 'siteMetadata.social.qiita'
  | 'polyfill'
  | 'pathPrefix'
  | 'jsxRuntime'
  | 'trailingSlash'
...
type WorkPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }>, readonly allMarkdownRemark: { readonly nodes: ReadonlyArray<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<(
...
type WorkPostBySlugQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title' | 'siteUrl'>> }>, readonly markdownRemark: Maybe<(
    Pick<MarkdownRemark, 'id' | 'excerpt' | 'html'>
    & { readonly frontmatter: Maybe<(
      Pick<Frontmatter, 'title' | 'date' | 'description' | 'tags' | 'thumbnailAlt' | 'link'>
      & { readonly thumbnail: Maybe<{ readonly childImageSharp: Maybe<(
          Pick<ImageSharp, 'gatsbyImageData'>
          & { readonly fluid: Maybe<Pick<ImageSharpFluid, 'originalImg'>> }
        )> }> }
    )> }
  )>, readonly previous: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title'>> }>, readonly next: Maybe<{ readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'title'>> }> };
...
type IndexPageQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
    ...
    )> }>, readonly blogs: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
      & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<Pick<Frontmatter, 'date' | 'title' | 'description' | 'tags'>> }
    )> }, readonly works: { readonly nodes: ReadonlyArray<(
      Pick<MarkdownRemark, 'excerpt'>
      & { readonly fields: Maybe<Pick<Fields, 'slug'>>, readonly frontmatter: Maybe<(
        Pick<Frontmatter, 'title' | 'thumbnailAlt'>
        & { readonly thumbnail: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
      )> }
    )> } };
